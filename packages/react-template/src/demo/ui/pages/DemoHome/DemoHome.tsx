...
export const DemoHome = () => (
  <div className={classes.container}>
    ...
    <div className={classes.paragraphContainer}>
      ...
      <div className={classes.infoSection}>
        <p className={classes.paragraphStyle}>
          Each page below demonstrates a different aspect of the template. The React Query example resolves its use case
          through Inversify, the React Hook Form example stays focused on UI composition, and the dependency injection
          example makes the layer boundaries explicit.
        </p>
      </div>
